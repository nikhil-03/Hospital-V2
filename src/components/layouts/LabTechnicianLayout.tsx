...
const LabTechnicianLayout = () => {
  ...
  const navigation = [
    ...
    { name: "Test Requests", href: "/test-requests", icon: TestTube },
    { name: "In Progress", href: "/in-progress", icon: Clock },
    { name: "Completed Tests", href: "/completed", icon: CheckCircle },
    { name: "Test Results", href: "/results", icon: FileText },
    { name: "Sample Tracking", href: "/samples", icon: Microscope },
      ...
      >
        ...
        <div className="mt-8 px-3">
          ...
          <div className="mt-2 space-y-2">
            <div className="px-3 py-2 bg-yellow-50 dark:bg-warning-900/20 rounded-md">
              <div className="text-sm font-medium text-yellow-800 dark:text-warning-400">
                12
              </div>
              <div className="text-xs text-yellow-600 dark:text-warning-500">
                Pending Tests
              </div>
            </div>
