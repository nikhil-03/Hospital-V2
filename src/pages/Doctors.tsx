...
const Doctors = () => {
  ...
  const handleSubmitBooking = () => {
    if (selectedDoctor && bookingData.date && bookingData.time && bookingData.symptoms) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600">Find and book appointments with our specialists</p>
        </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center mt-2">
                    ...
                    <span className="text-sm text-gray-500 ml-2">({doctor.totalPatients} patients)</span>
                  </div>
